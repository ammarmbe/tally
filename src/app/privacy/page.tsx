...
export default function Page() {
  return (
    <main className="mx-auto flex w-full max-w-7xl flex-grow flex-col p-4 sm:px-8">
      ...
      <h2 className="pt-6 text-text-xl font-semibold">1. Introduction</h2>

      <p className="text-secondary pt-4 text-text-md">
        Welcome to Tally (“we”, “our”, “us”). We are committed to protecting
        your privacy and ensuring that your personal data is handled with the
        utmost care. This Privacy Policy outlines how we collect, use, and
        protect your information when you use our website and services.
      </p>

      <h2 className="pt-6 text-text-xl font-semibold">
        2. Information We Collect
      </h2>

      <ul className="text-secondary list-inside list-disc pt-4">
        <li>
        ...
        <li>
          ...
          information related to your university lectures and attendance, which
      ...
      <ul className="text-secondary list-inside list-disc pt-4">
        <li>
          Enable you to track and manage your university lectures and
          attendance.
        </li>
      ...
      <h2 className="pt-6 text-text-xl font-semibold">6. User Rights</h2>

      <p className="text-secondary pt-4 text-text-md">You have the right to:</p>
      ...
      <h2 className="pt-6 text-text-xl font-semibold">8. Contact Us</h2>
