...
export const inputStyles = (
  ...
  twMerge(
    "rounded-md h-fit disabled:!text-disabled disabled:!border-disabled disabled:!bg-disabled disabled:!shadow-none border transition-all shadow-xs placeholder:text-placeholder bg-primary resize-none",
